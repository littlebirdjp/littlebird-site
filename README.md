...
1. [デザインカンプの作成](#user-content-デザインカンプの作成)
	1. [アートボードの作成](#user-content-アートボードの作成)
	2. [モバイル版のデザインカンプを作成](#user-content-モバイル版のデザインカンプを作成)
	3. [共通スタイルをShared Styleに登録](#user-content-共通スタイルをshared-styleに登録)
	4. [共通化できるパーツをシンボルに登録](#user-content-共通化できるパーツをシンボルに登録)
	5. [タブレット／デスクトップ版のデザインカンプを作成](#user-content-タブレット／デスクトップ版のデザインカンプを作成)
	6. [パーツの書き出し設定](#user-content-パーツの書き出し設定)
	7. [パーツの書き出し](#user-content-パーツの書き出し)
2. [Bootstrapの環境準備](#user-content-bootstrapの環境準備)
	1. [BowerでBootstrapをダウンロード](#user-content-bowerでbootstrapをダウンロード)
	2. [Gruntのインストール](#user-content-gruntのインストール)
	3. [Gruntの動作確認](#user-content-gruntの動作確認)
	4. [オリジナルCSSの追加](#user-content-オリジナルcssの追加)
	5. [変数用ファイルの追加](#user-content-変数用ファイルの追加)
	6. [minifyの設定を追加](#user-content-minifyの設定を追加)
3. [コーディング](#user-content-コーディング)
	1. [HTMLの雛形を作成](#user-content-htmlの雛形を作成)
	2. [コンポーネントの配置](#user-content-コンポーネントの配置)
	3. [グリッドレイアウトの調整](#user-content-グリッドレイアウトの調整)
	4. [オリジナルClassの追加](#user-content-オリジナルclassの追加)
	5. [各コンポーネントスタイルの編集](#user-content-各コンポーネントスタイルの編集)
	6. [レスポンシブスタイルの追加](#user-content-レスポンシブスタイルの追加)
4. [サイトの公開](#user-content-サイトの公開)
